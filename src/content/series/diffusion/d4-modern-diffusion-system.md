...
4. 采样沿哪条随机或确定性轨迹进行，又采用哪种 solver 和哪些离散点？
...
- sampler 决定怎样使用已经学到的函数，而不改变训练数据本身。
...
## 2. 2021—2023：prediction target 可以互相转换，为什么训练仍不相同
...
## 5. 2021—2022：sampler 使用已训练的向量场，而不是重新学习模型
